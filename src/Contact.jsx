    ...
    >
      <div className="lg:w-2/3">
        ...
        <div className="flex flex-row w-48 justify-start space-x-2 py-2">
          ...
          <a
            href="mailto:zain171m@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
      ...
      <div className="pt-16 w-4/6 md:w-1/3 flex flex-row justify-center content-center">
        <div className=" xl:w-3/4 border-dotted-white">
          <img
            src="https://avatars.githubusercontent.com/u/73698969?v=4"
            alt="Logo"
            className="object-fill rounded-full border-purple-300 border-4"
          />
        </div>
      </div>
      <footer className="text-white text-center py-4 pt-20 mt-auto">
        <div className="container mx-auto">
          <p className="text-sm">
            &copy; {new Date().getFullYear()} Muhammad Zain Nasir. All rights
            reserved.
          </p>
        </div>
      </footer>
